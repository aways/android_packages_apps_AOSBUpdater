...
package com.aosb.updater.utils;
...
public class Utils {
    ...
    public static String getDeviceType() {
        return SystemProperties.get("ro.aosb.device");
    }

    public static String getInstalledVersion() {
        return SystemProperties.get("ro.aosb.version");
    }
    ...
    public static boolean isOnline(Context context) {
        ...
        NetworkInfo netInfo = aosb.getActiveNetworkInfo();
