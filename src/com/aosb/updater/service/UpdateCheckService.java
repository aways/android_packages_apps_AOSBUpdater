...
package com.aosb.updater.service;
...
import com.aosb.updater.R;
import com.aosb.updater.UpdateApplication;
import com.aosb.updater.UpdatesSettings;
import com.aosb.updater.misc.Constants;
import com.aosb.updater.misc.State;
import com.aosb.updater.misc.UpdateInfo;
import com.aosb.updater.receiver.DownloadReceiver;
import com.aosb.updater.utils.HttpRequestExecutor;
import com.aosb.updater.utils.Utils;
...
public class UpdateCheckService extends IntentService {
    ...
    // request actions
    public static final String ACTION_CHECK = "com.aosb.aosbupdater.action.CHECK";
    public static final String ACTION_CANCEL_CHECK = "com.aosb.aosbupdater.action.CANCEL_CHECK";

    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.aosb.aosbupdater.action.UPDATE_CHECK_FINISHED";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (realUpdateCount != 0 && !app.isMainActivityActive()) {
            ...
            Notification.Builder builder = new Notification.Builder(this)
                    .setSmallIcon(R.drawable.aosb_updater)
    ...
    private URI getServerURI() {
        String propertyUpdateUri = SystemProperties.get("aosb.updater.uri");
    ...
    private JSONObject buildUpdateRequest(int updateType) throws JSONException {
        ...
        params.put("device", TESTING_DOWNLOAD ? "aosbtestdevice" : Utils.getDeviceType());
