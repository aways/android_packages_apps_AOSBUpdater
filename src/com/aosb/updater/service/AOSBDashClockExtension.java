...
public class AOSBDashClockExtension extends DashClockExtension {
    private static final String TAG = "AOSBDashClockExtension";

    public static final String ACTION_DATA_UPDATE = "com.aosb.updater.action.DASHCLOCK_DATA_UPDATE";
